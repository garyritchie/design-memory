/**
 * Extract CSS class patterns from key elements and detect Tailwind usage.
 */
...
/**
 * Analyze classes from crawled HTML.
 * Scans key elements and detects Tailwind utility patterns.
 */
export function analyzeClasses(html: string): ClassAnalysis {
