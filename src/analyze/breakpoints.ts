 ...
 * Parses inline <style> and linked stylesheets from crawled HTML.
 */
...
/**
 * Parse CSS text for @media min-width / max-width values.
 */
 ...
 */
export function analyzeBreakpoints(html: string): BreakpointAnalysis {
  ...
  return { breakpoints: uniqueValues, raw: uniqueRaw };
}
